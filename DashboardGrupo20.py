...
# En cmd "streamlit run DashboardGrupo20.py"
...
with c1_f5:
    st.write("### Análisis de Correlación Numérica")
    #Creación de la figura
...
with c2_f5:
    st.write("### Composición Ingreso Bruto por Sucursal y Línea de Producto")
    #Condicional para filtrar gráfico por Línea de Producto y fecha
    if filtro_linea_producto:
